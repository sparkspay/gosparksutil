...
import (
	...
	"github.com/sparkspay/gosparksutil/base58"
)
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := gosparksutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*gosparksutil.AddressPubKeyHash, error) {
	pkHash := gosparksutil.Hash160(k.pubKeyBytes())
	return gosparksutil.NewAddressPubKeyHash(pkHash, net)
}
