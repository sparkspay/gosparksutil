...
// Tx returns a wrapped transaction (gosparksutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (gosparksutil.Tx) for all
...
// instead provides easy access to wrapped versions (gosparksutil.Tx) of them.
