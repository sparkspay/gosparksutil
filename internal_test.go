...
/*
This test file is part of the gosparksutil package rather than than the
gosparksutil_test package so it can bridge access to the internals to properly test
...
import (
	...
	"github.com/sparkspay/gosparksutil/bech32"
