...
import (
	...
	"github.com/sparkspay/gosparksutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    gosparksutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() gosparksutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value gosparksutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
type coinSelectTest struct {
	...
	targetValue   gosparksutil.Amount
...
var (
	...
	testSimpleCoinTxValue0            = gosparksutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = gosparksutil.NewTxFromBytes(testSimpleCoinTxBytes)
